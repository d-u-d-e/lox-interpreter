...
namespace expr
{
    ...
    struct Variable : public ExprBase, public std::enable_shared_from_this<const Variable>
    {
        ...
        std::string accept(Visitor<std::string> &visitor) const override { return visitor.visit_variable_expr(shared_from_this()); }
        Value accept(Visitor<Value> &visitor) const override { return visitor.visit_variable_expr(shared_from_this()); }
        void accept(Visitor<void> &visitor) const override { visitor.visit_variable_expr(shared_from_this()); }
        Token token;
    };
    ...
    struct Assignment : public ExprBase, public std::enable_shared_from_this<const Assignment>
    {
        ...
        std::string accept(Visitor<std::string> &visitor) const override { return visitor.visit_assignment_expr(shared_from_this()); }
        Value accept(Visitor<Value> &visitor) const override { return visitor.visit_assignment_expr(shared_from_this()); }
        void accept(Visitor<void> &visitor) const override { visitor.visit_assignment_expr(shared_from_this()); }
        Token token;
